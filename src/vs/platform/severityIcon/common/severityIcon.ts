...
import { hintForeground, infoForeground, warningForeground, errorForeground } from 'vs/platform/theme/common/colorRegistry';
	...
	export function getSVGData(severity: Severity, theme: ITheme): string {
		switch (severity) {
			case Severity.Ignore:
				const ignoreColor = theme.getColor(hintForeground) || (theme.type === LIGHT ? Color.fromHex('#1BA1E2') : Color.fromHex('#1BA1E2'));
			...
			case Severity.Info:
				const infoColor = theme.getColor(infoForeground) || (theme.type === LIGHT ? Color.fromHex('#1BA1E2') : Color.fromHex('#1BA1E2'));
			...
			case Severity.Warning:
				const warningColor = theme.getColor(warningForeground) || (theme.type === LIGHT ? Color.fromHex('#fc0') : Color.fromHex('#fc0'));
			...
			case Severity.Error:
				const errorColor = theme.getColor(errorForeground) || (theme.type === LIGHT ? Color.fromHex('#E51400') : Color.fromHex('#F48771'));
